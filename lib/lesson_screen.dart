  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: [
            DayQuestion(_dayQuestions['one'], _memoryVerse),
            DayQuestion(_dayQuestions['two']),
            DayQuestion(_dayQuestions['three']),
            DayQuestion(_dayQuestions['four']),
            DayQuestion(_dayQuestions['five']),
            DayQuestion(_dayQuestions['six']),
          ],
        ),
      ),
    );
